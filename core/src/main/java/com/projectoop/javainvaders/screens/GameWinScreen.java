...
/**
 * Classe responsável unicamente por desenhar a tela de vitória. Não contém
...
public class GameWinScreen implements Screen {
    ...
    public GameWinScreen(JavaInvadersGame game, int score) {
        this.game = game;
    ...
    public void show() {
        ...
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("win_music.mp3"));
        backgroundMusic.setLooping(true);
        backgroundMusic.setVolume(0.5f);
        backgroundMusic.play();

        // Carrega a imagem de fundo de vitória
        ...
        // Estilo dos Textos (Cor Verde/Amarela para Vitória)
        Label.LabelStyle labelStyleTitle = new Label.LabelStyle();
        labelStyleTitle.font = font;
        labelStyleTitle.fontColor = Color.GREEN; // Título em verde!

        Label.LabelStyle labelStyleScore = new Label.LabelStyle();
        labelStyleScore.font = font;
        labelStyleScore.fontColor = Color.YELLOW;

        Label titleLabel = new Label("YOU WIN!", labelStyleTitle);
        ...
        buttonStyle.overFontColor = Color.GREEN; // Fica verde ao passar o mouse
        ...
        // Ordem: Fundo primeiro, tabela por cima
    ...
    public void render(float delta) {
        // Fundo azul escuro para dar um contraste legal com o verde
